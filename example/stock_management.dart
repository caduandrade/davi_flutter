...
class _HomePageState extends State<HomePage> {
  ...
  void _buildModel() {
    ...
    _model = DaviModel<Data>(
      rows: rows,
      columns: [
        DaviColumn(name: 'Product', cellValue: (params) => params.data.product),
        DaviColumn(
          name: 'Category',
          cellValue: (params) => params.data.category,
        ),
        DaviColumn(
          name: 'Price',
        ...
        DaviColumn(
          ...
          cellBarValueStringify:
              (params) => '${params.data.stock}/${params.data.stockLimit}',
